...
- [Correctness Properties](#correctness-properties)
  - [Property 1: 多次存取回傳相同實例](#property-1-多次存取回傳相同實例)
  - [Property 2: 反射防護——建構子防衛子句阻止第二個實例](#property-2-反射防護建構子防衛子句阻止第二個實例)
  - [Property 3: 執行緒安全——並發存取只建立一個實例](#property-3-執行緒安全並發存取只建立一個實例)
  - [Property 4: 序列化往返保持同一實例](#property-4-序列化往返保持同一實例)
  - [Property 5: 並發狀態修改的安全性與可見性](#property-5-並發狀態修改的安全性與可見性)
- [錯誤處理](#錯誤處理)
  - [錯誤場景與對應策略](#錯誤場景與對應策略)
  - [例外訊息設計](#例外訊息設計)
- [測試策略](#測試策略)
...
### Property 2: 反射防護——建構子防衛子句阻止第二個實例
